            ...
            >
                ...
                <div className="relative z-10 flex flex-col justify-center items-center mb-28">
                    <div className="relative mb-[6rem] sm:mb-[7rem] flex justify-center items-center">
                        <img src={props.logo1} alt="logoNav" className="w-full h-[200px] md:h-[260px] lg:h-[320px]" />
                        <img src={props.logo2} alt="logoNav" className="absolute w-full h-[60%] top-[11rem] md:top-[15rem] lg:top-[17rem]" />
                    </div>
