...
const Navbar = () => {
  ...
  return (
    <nav className="bg-[#111111] text-white shadow-md">
      <div className={isOpen ? 'border-none' : 'border-b-2 border-red-600'}>
        <div className="max-w-7xl mx-auto lg:px-8">
          <div className="flex justify-center items-center py-4 lg:justify-between">
            ...
            <div>
              <Link href="/">
                <img src="/images/logoNav.png" alt="logoNav" className="h-[3rem]" />
              </Link>
            </div>
            <div className="hidden lg:flex space-x-6">
              <Link href="/">
                <p className="border-2 border-white text-white px-6 py-1 rounded-md opacity-70 hover:text-opacity-100 hover:opacity-100 hover:bg-white hover:bg-opacity-50 transition">
                  Rank</p>
              </Link>
              <Link href="/">
                <p className="border-2 border-white text-white px-6 py-1 rounded-md opacity-70 hover:text-opacity-100 hover:opacity-100 hover:bg-white hover:bg-opacity-50 transition">
          ...
          {isOpen && (
            <div className="bg-[#111111] flex flex-col items-center pt-4 border-t border-red-600 w-">
