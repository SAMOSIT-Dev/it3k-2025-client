...
> = {
  'KMUTT': { tradition_game_points: 4, esport_point: 14 },
  'KMITL': { tradition_game_points: 4, esport_point: 16 },
  'KMUTNB': { tradition_game_points: 1, esport_point: 4 },
  'KMUTNB_PR': { tradition_game_points: 8, esport_point: 2 }
}
