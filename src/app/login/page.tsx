...
const AdminRoleMapURL: { [key: string]: string } = {
  super_admin: '/',
  admin_football: '/admin/football',
  admin_basketball: '/admin/basketball',
  admin_badminton: '/bracket/badminton',
  admin_pingpong: '/bracket/pingpong',
  admin_athletics: '/admin/athletics'
}
...
export default function LoginForm() {
  ...
  const [error, setError] = useState<string | null>(null)
    ...
    useEffect(() => { 
        if (admin) {
            router.push(AdminRoleMapURL[admin.role])
        }
    }, [admin, router])
